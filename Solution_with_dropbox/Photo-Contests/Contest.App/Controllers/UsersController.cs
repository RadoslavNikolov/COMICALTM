        ...
        public async Task<ActionResult> Edit(UserEditBindingModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                if (model.Upload != null)
                {
                    ...
                    if (user.Files.Any())
                    {
                        //This will set file UserId to null
                ...
                if (result.Succeeded)
                {
                    ...
                    //Clear database from file with UserId == null
                    var files = this.ContestsData.Files.All().Where(f => f.UserId == null);
                    foreach (var file in files)
                    {
                        this.ContestsData.Files.Remove(file);
                    }
                    this.ContestsData.SaveChanges();
